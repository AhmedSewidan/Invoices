		...
		<div class="modal-content chat border-0">
			<div class="card overflow-hidden mb-0 border-0">
				...
				<div class="action-header clearfix">
					<div class="float-left hidden-xs d-flex ml-2" id="user-inside-chat">
						<div class="img_cont mr-3">
							<img src="" class="rounded-circle user_img" alt="img">
						</div>
						<div class="align-items-center mt-2">
							<h4 class="text-white mb-0 font-weight-semibold" id="user_name"></h4>
							<span class="dot-label bg-success"></span><span class="mr-3 text-white"></span>
						</div>
					</div> 
